...
<div class="max-w-xl">
    <div class="bg-white rounded-xl shadow p-6">
        <h2 class="text-lg font-bold mb-4">Editar Capacitación</h2>

        <form action="{{ route('capacitaciones.update', $capacitacione->id_capacitacion) }}" method="POST">
            @csrf
            @method('PUT')

            <div class="mb-4">
                <label class="block mb-1 font-medium">Nombre <span class="text-red-500">*</span></label>
                <input type="text" name="nombre" value="{{ old('nombre', $capacitacione->nombre) }}" required
            ...
            <div class="mb-4">
                ...
                <textarea name="descripcion" rows="3"
                    class="w-full border rounded px-3 py-2 @error('descripcion') border-red-500 @enderror">{{ old('descripcion', $capacitacione->descripcion) }}</textarea>
            ...
            <div class="mb-4">
                ...
                <input type="url" name="url_video" value="{{ old('url_video', $capacitacione->url_video) }}"
            ...
            <div class="mb-6">
                ...
                <input type="number" name="duracion_minutos" value="{{ old('duracion_minutos', $capacitacione->duracion_minutos) }}" min="1"
