...
<div class="max-w-xl">
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <form action="{{ route('tipo-evento.update', $tipoEvento->id_tipo_evento) }}" method="POST">
            @csrf
            @method('PUT')

            <div class="mb-4">
                <label class="block mb-1 font-medium">Nombre <span class="text-red-500">*</span></label>
                <input type="text" name="nombre" value="{{ old('nombre', $tipoEvento->nombre) }}" required
            ...
            <div class="mb-6">
                ...
                <textarea name="descripcion" rows="3"
                    class="w-full border rounded px-3 py-2 @error('descripcion') border-red-500 @enderror">{{ old('descripcion', $tipoEvento->descripcion) }}</textarea>
