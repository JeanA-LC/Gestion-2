...
@section('title', 'Editar Mesa de Sufragio')
...
<div class="max-w-xl">
    <div class="bg-white rounded-xl shadow p-6">
        <h2 class="text-lg font-bold mb-4">Editar Mesa de Sufragio</h2>

        <form action="{{ route('mesas-sufragio.update', $mesasSufragio->id_mesa) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <select name="id_centro_votacion" required
                    ...
                    @foreach($centros as $centro)
                        <option value="{{ $centro->id_centro_votacion }}" {{ old('id_centro_votacion', $mesasSufragio->id_centro_votacion) == $centro->id_centro_votacion ? 'selected' : '' }}>
                            {{ $centro->nombre }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="codigo_mesa" value="{{ old('codigo_mesa', $mesasSufragio->codigo_mesa) }}" required
            ...
            <div class="mb-6">
                ...
                <input type="number" name="electores" value="{{ old('electores', $mesasSufragio->electores) }}" min="0"
